 ...
 #define GPIO_W5500_CS                    GPIOB
 #define RCC_APB2Periph_GPIO_W5500_CS     RCC_APB2Periph_GPIOB
 #define GPIO_Pin_CS_W5500                GPIO_Pin_6
 #define RCC_APBPeriphClockCmd_CS_W5500   RCC_APB2PeriphClockCmd
 #define RCC_APB2Periph_GPIO_W5500        RCC_APB2Periph_GPIOB
 #define GPIO_SPI_W5500                   GPIOB
 #define GPIO_Pin_SPI_W5500_SCK           GPIO_Pin_3
 #define GPIO_Pin_SPI_W5500_MISO          GPIO_Pin_4
 #define GPIO_Pin_SPI_W5500_MOSI          GPIO_Pin_5
