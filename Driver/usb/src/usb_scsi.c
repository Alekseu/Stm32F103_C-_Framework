...
#include "../inc/usb_scsi.h"
#include "../inc/mass_mal.h"
#include "../inc/usb_bot.h"
#include "../inc/usb_regs.h"
#include "../inc/memory.h"
#include "../inc/nand_if.h"
...
*******************************************************************************/
FunctionalState SCSI_Address_Management(uint8_t lun , uint8_t Cmd , uint32_t LBA , uint32_t BlockNbr)
{
